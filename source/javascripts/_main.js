...
(function() {
    ...
    var width, largeHeader, canvas, ctx, triangles, target, animateHeader = true;
    var colors = ['26,64,85'];
    ...
    function tweenTriangle(tri) {
        ...
        var y = (200+Math.random()*800)*Math.sin(t) + height*0.5-20;
    ...
    function Triangle() {
        ...
        function init() {
            ...
            setTimeout(function() { _this.alpha = 1; }, 10);
        }
